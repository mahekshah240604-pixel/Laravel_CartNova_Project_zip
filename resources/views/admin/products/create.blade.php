...
<div class="layout">
    <nav class="sidebar">
        ...
        <a href="{{ route('admin.products.create') }}" class="active"><span class="icon">➕</span> Add Product</a>
            ...
            <div class="card">
                ...
                <div class="form-grid full" style="margin-bottom:12px">
                    <div class="field">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Apple iPhone 15 Pro Max">
            ...
            <div class="card">
                ...
                <div class="form-grid three" style="margin-bottom:12px">
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="original_price" value="{{ old('original_price') }}" placeholder="0.00" step="0.01" min="0">
                ...
                <div class="form-grid three">
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="rating" value="{{ old('rating',4.0) }}" step="0.1" min="0" max="5">
                    </div>
                    <div class="field">
            ...
            <div class="card">
                ...
                <div style="display:flex;gap:24px;flex-wrap:wrap">
                    <label class="check-group">
                        <input type="checkbox" name="is_prime" value="1" {{ old('is_prime') ? 'checked' : '' }}>
                        ⚡ Prime Eligible
                    </label>
                    <label class="check-group">
