...
<div class="layout">
    <nav class="sidebar">
        ...
        <a href="<?php echo e(route('admin.users.index')); ?>" class="active"><span class="icon">👥</span> All Users</a>
    ...
    <main class="main">
        ...
        <div class="toolbar">
            <h1>👥 Users (<?php echo e($users->total()); ?>)</h1>
            <form method="GET" style="display:flex;gap:8px">
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search by name or email...">
                <button type="submit" class="btn btn-primary">Search</button>
                <?php if(request('search')): ?><a href="<?php echo e(route('admin.users.index')); ?>" class="btn" style="border-color:var(--border)">Clear</a><?php endif; ?>
            </form>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:.82rem"><?php echo e($user->phone ?? '—'); ?></td>
                    <td>
                        <span class="badge <?php echo e($user->is_admin ? 'badge-admin' : 'badge-user'); ?>">
                            <?php echo e($user->is_admin ? '⚙️ Admin' : '👤 User'); ?>

                        </span>
                    </td>
                    <td><?php echo e($user->orders_count ?? 0); ?></td>
                    <td style="font-size:.82rem;white-space:nowrap"><?php echo e($user->created_at->format('d M Y')); ?></td>
                        ...
                        <?php if($user->id !== auth()->id()): ?>
                            ...
                            <form action="<?php echo e(route('admin.users.toggle-admin', $user->id)); ?>" method="POST" style="display:inline">
                                ...
                                <button type="submit" class="btn btn-sm"
                                        ...
                                        onclick="return confirm('<?php echo e($user->is_admin ? 'Remove admin access from' : 'Grant admin access to'); ?> <?php echo e(addslashes($user->name)); ?>?')">
                            ...
                            <form action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" style="display:inline">
                                ...
                                <button type="submit" class="btn btn-danger btn-sm"
                                        onclick="return confirm('Delete <?php echo e(addslashes($user->name)); ?>? This cannot be undone.')">
                                    Delete
                                </button>
                            </form>
                        <?php else: ?>
        ...
        <div class="pagination">
            <?php if($users->onFirstPage()): ?><span class="disabled">← Prev</span><?php else: ?><a href="<?php echo e($users->previousPageUrl()); ?>">← Prev</a><?php endif; ?>
            <?php $__currentLoopData = range(1,$users->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($p==$users->currentPage()): ?><span class="active"><?php echo e($p); ?></span>
                <?php else: ?><a href="<?php echo e($users->url($p)); ?>"><?php echo e($p); ?></a><?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($users->hasMorePages()): ?><a href="<?php echo e($users->nextPageUrl()); ?>">Next →</a><?php else: ?><span class="disabled">Next →</span><?php endif; ?>
        </div>
    </main>
</div>
<footer>© 1996–2025, CartNova · Admin Panel · All rights reserved</footer>
</body>
</html><?php /**PATH C:\xampp\htdocs\laravel\userside_project\resources\views/admin/users/index.blade.php ENDPATH**/ ?>