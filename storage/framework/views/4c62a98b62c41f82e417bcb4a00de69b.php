    ...
    <a href="<?php echo e(route('admin.invoice.download', $order->id)); ?>"
       ...
       style="background:#FF9900;border-color:#FF9900;color:#000">
        📄 Download Invoice
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-back" style="margin-left:auto">← Back to Orders</a>
        </div>
        ...
        <div class="section">
            ...
            <div style="display:flex;gap:20px;flex-wrap:wrap;margin-bottom:12px;font-size:.85rem">
                <div><span style="color:var(--muted)">Order # </span><strong><?php echo e($order->order_number); ?></strong></div>
                <div><span style="color:var(--muted)">Date: </span><strong><?php echo e($order->placed_at->format('d M Y, h:i A')); ?></strong></div>
                <div><span style="color:var(--muted)">Payment: </span><strong><?php echo e($order->payment_label); ?></strong></div>
                <div><span style="color:var(--muted)">Pay Status: </span>
                    <strong style="color:<?php echo e($order->payment_status=='paid'?'#007600':'#856404'); ?>">
            ...
            <div class="info-grid">
                ...
                <div class="info-box">
                    ...
                    <p>
                        ...
                        <?php if($order->address_line2): ?><?php echo e($order->address_line2); ?><br><?php endif; ?>
        ...
        <div class="section">
            <h2>🛍️ Items (<?php echo e($order->items->count()); ?>)</h2>
            ...
            <div class="item-row">
                ...
                <div class="item-info">
                    ...
                    <div class="item-sub"><?php echo e($item->product_brand); ?> · Qty: <?php echo e($item->quantity); ?> · ₹<?php echo e(number_format($item->price,0)); ?> each</div>
                </div>
                <div class="item-price">₹<?php echo e(number_format($item->subtotal,0)); ?></div>
            ...
            <div style="background:#f9f9f9;border-radius:4px;padding:14px;margin-top:14px">
                <div class="price-row"><span>Subtotal</span><span>₹<?php echo e(number_format($order->subtotal,0)); ?></span></div>
                <?php if($order->discount > 0): ?>
                <div class="price-row green"><span>Discount</span><span>-₹<?php echo e(number_format($order->discount,0)); ?></span></div>
                <?php endif; ?>
                <div class="price-row"><span>Delivery</span><span><?php echo e($order->delivery_charge==0?'FREE':'₹'.$order->delivery_charge); ?></span></div>
                <hr class="pdiv">
                <div class="price-total"><span>Order Total</span><span>₹<?php echo e(number_format($order->total,0)); ?></span></div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\userside_project\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>