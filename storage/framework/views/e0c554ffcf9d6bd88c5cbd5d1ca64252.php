...
<div class="page">
    <div class="card">
        ...
        <?php if(session('error')): ?>
            <div class="alert">⚠️ <?php echo e(session('error')); ?></div>
        <?php endif; ?>

        
        <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" id="loginForm" novalidate>
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\userside_project\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>