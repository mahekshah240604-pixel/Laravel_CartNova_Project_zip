...
<header class="topbar">
    ...
    <div class="topbar-right">
        <a href="<?php echo e(route('home')); ?>">← Store Front</a>
...
<div class="layout">
    ...
    <nav class="sidebar">
        ...
        <a href="<?php echo e(route('admin.products.index')); ?>">📦 Products</a>
        <a href="<?php echo e(route('admin.products.create')); ?>">➕ Add Product</a>

        <div class="sidebar-section">Sales</div>
        <a href="<?php echo e(route('admin.orders.index')); ?>">
            🛒 All Orders
            <?php if(($stats['pending_orders'] ?? 0) > 0): ?>
                <span class="badge"><?php echo e($stats['pending_orders']); ?></span>
            <?php endif; ?>
        </a>
    ...
    <main class="main">
        ...
        <div class="stats-grid">
            <div class="stat-card">👥 Users<br><span class="value"><?php echo e($stats['total_users'] ?? 0); ?></span></div>
            <div class="stat-card">📦 Products<br><span class="value"><?php echo e($stats['total_products'] ?? 0); ?></span></div>
            <div class="stat-card">🛒 Orders<br><span class="value"><?php echo e($stats['total_orders'] ?? 0); ?></span></div>
            <div class="stat-card">💰 Revenue<br><span class="value">₹<?php echo e(number_format($stats['total_revenue'] ?? 0)); ?></span></div>
            <div class="stat-card">🕐 Pending<br><span class="value"><?php echo e($stats['pending_orders'] ?? 0); ?></span></div>
            <div class="stat-card">⚠️ Low Stock<br><span class="value"><?php echo e($stats['low_stock'] ?? 0); ?></span></div>
        </div>

            <div class="section">
                <h2>📋 Orders by Status</h2>
                <div class="status-chart">
                    <?php $__currentLoopData = ['pending'=>'🕐','confirmed'=>'✅','shipped'=>'🚚','delivered'=>'🏠','cancelled'=>'❌']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s=>$icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="status-item">
                        <div class="num"><?php echo e($ordersByStatus[$s] ?? 0); ?></div>
                        <div class="lbl"><?php echo e($icon); ?> <?php echo e(ucfirst($s)); ?></div>
                    </div>
            ...
            <div class="section">
                <h2>⭐ Top Products <a href="<?php echo e(route('admin.products.index')); ?>">View all</a></h2>
                ...
                <div class="product-row">
                    ...
                    <div class="product-row-info">
                        <div class="product-row-name"><?php echo e($p->name); ?></div>
                        <div class="product-row-sub"><?php echo e($p->category); ?> · Stock: <?php echo e($p->stock); ?></div>
                    </div>
                    <div class="product-row-price">₹<?php echo e(number_format($p->price,0)); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                         ...
                         <td><a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" style="font-size:.8rem"><?php echo e($order->order_number); ?></a></td>
                        <td><?php echo e($order->user->name ?? 'N/A'); ?></td>
                        <td style="white-space:nowrap"><?php echo e($order->placed_at->format('d M Y')); ?></td>
                        ...
                        <td><a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="btn btn-primary btn-sm">View</a></td>

                        <td>
                            <a href="<?php echo e(route('admin.invoice.download', $order->id)); ?>"
...
</html><?php /**PATH C:\xampp\htdocs\laravel\userside_project\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>