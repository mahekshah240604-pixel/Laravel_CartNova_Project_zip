...
<div class="layout">
    ...
    <main class="main">
        <h1 style="font-size:1.3rem;font-weight:700;margin-bottom:16px">🎟️ Edit Coupon: <?php echo e($coupon->code); ?></h1>
        ...
        <div class="preview-box" id="previewBox">
            <div class="preview-code" id="previewCode"><?php echo e($coupon->code); ?></div>
            ...
            <div class="preview-desc" id="previewDesc"><?php echo e($coupon->description ?: 'Coupon preview'); ?></div>
        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="description" value="<?php echo e(old('description', $coupon->description)); ?>"
                ...
                <div class="form-grid three">
                    <div class="field">
                        ...
                        <select name="type" id="typeSelect" onchange="updatePreview()">
                            <option value="percentage" <?php echo e(old('type', $coupon->type) == 'percentage' ? 'selected' : ''); ?>">
                                Percentage (%)
                            </option>
                            <option value="fixed" <?php echo e(old('type', $coupon->type) == 'fixed' ? 'selected' : ''); ?>">
                                Fixed Amount (₹)
                            </option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="value" id="valueInput"
                               value="<?php echo e(old('value', $coupon->value)); ?>" min="1" step="0.01"
                               placeholder="e.g. 50"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="max_discount" value="<?php echo e(old('max_discount', $coupon->max_discount)); ?>"
                ...
                <div class="form-grid three" style="margin-bottom:12px">
                    <div class="field">
                        ...
                        <input type="number" name="min_order_amount"
                               value="<?php echo e(old('min_order_amount', $coupon->min_order_amount)); ?>" min="0" step="1" placeholder="0">
                        <span class="hint">0 = no minimum</span>
                    </div>
                    <div class="field">
                        <label>Total Usage Limit</label>
                        <input type="number" name="usage_limit"
                               value="<?php echo e(old('usage_limit', $coupon->usage_limit)); ?>" min="1" placeholder="Leave blank = unlimited">
                        <span class="hint">Max total uses</span>
                    </div>
                    <div class="field">
                        <label>Per User Limit</label>
                        <input type="number" name="per_user_limit"
                               value="<?php echo e(old('per_user_limit', $coupon->per_user_limit)); ?>" min="1" placeholder="1">
            ...
            <div style="display:flex;gap:10px">
                ...
                <a href="<?php echo e(route('admin.coupons.index')); ?>" class="btn btn-cancel">Cancel</a>
            </div>
        </form>
    </main>
</div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\userside_project\resources\views/admin/coupons/edit.blade.php ENDPATH**/ ?>