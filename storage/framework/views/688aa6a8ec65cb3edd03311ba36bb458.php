...
.field textarea:focus{
    border-color:#e77600;
    box-shadow:0 0 0 3px rgba(228,121,17,.2);
}
...
<div class="layout">
    <nav class="sidebar">
        ...
        <a href="<?php echo e(route('admin.products.create')); ?>" class="active"><span class="icon">➕</span> Add Product</a>
    ...
    <main class="main">
        <h1 style="font-size:1.3rem;font-weight:700;margin-bottom:16px">➕ Add New Product</h1>
            ...
            <div class="card">
                ...
                <div class="form-grid full" style="margin-bottom:12px">
                    <div class="field">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g. Apple iPhone 15 Pro Max">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="field">
                        <label>Brand</label>
                        <input type="text" name="brand" value="<?php echo e(old('brand')); ?>" placeholder="e.g. Apple">
                    </div>
                </div>
                <div class="form-grid full">
                    <div class="field">
                        <label>Description</label>
                        <textarea name="description" placeholder="Product description..."><?php echo e(old('description')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="form-grid three" style="margin-bottom:12px">
                    <div class="field">
                        ...
                        <input type="number" name="price" value="<?php echo e(old('price')); ?>" placeholder="0.00" step="0.01" min="0">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="original_price" value="<?php echo e(old('original_price')); ?>" placeholder="0.00" step="0.01" min="0">
                        <span class="hint">MRP / crossed-out price</span>
                    </div>
                    <div class="field">
                        <label>Discount (%)</label>
                        <input type="number" name="discount" value="<?php echo e(old('discount',0)); ?>" min="0" max="100">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="rating" value="<?php echo e(old('rating',4.0)); ?>" step="0.1" min="0" max="5">
                    </div>
                    <div class="field">
                        <label>Reviews Count</label>
                        <input type="number" name="reviews_count" value="<?php echo e(old('reviews_count',0)); ?>" min="0">
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div style="display:flex;gap:24px;flex-wrap:wrap">
                    <label class="check-group">
                        <input type="checkbox" name="is_prime" value="1" <?php echo e(old('is_prime') ? 'checked' : ''); ?>>
                        ⚡ Prime Eligible
                    </label>
                    <label class="check-group">
...
</html><?php /**PATH C:\xampp\htdocs\laravel\userside_project\resources\views/admin/products/create.blade.php ENDPATH**/ ?>